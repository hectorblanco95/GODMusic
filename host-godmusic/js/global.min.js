...
function clicks2() {
    i2++;
    if (i2 >= 1) {
        document.getElementById("clicks2").innerHTML = i2;
    }
}
var i3 = 0
...
function clicks3() {
    i3++;
    if (i3 >= 1) {
        document.getElementById("clicks3").innerHTML = i3;
    }
}
var i4 = 0
...
function clicks4() {
    i4++;
    if (i4 >= 1) {
        document.getElementById("clicks4").innerHTML = i4;
    }
}
var i5 = 0
...
function clicks5() {
    i5++;
    if (i5 >= 1) {
        document.getElementById("clicks5").innerHTML = i5;
    }
}
var i6 = 0
...
function clicks6() {
    i6++;
    if (i6 >= 1) {
        document.getElementById("clicks6").innerHTML = i6;
    }
}
