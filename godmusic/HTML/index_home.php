        ...
        <div class="modal-dialog">
            <div class="modal-content panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form href="/godmusic/HTML/profile.php" id="login-form" action="/godmusic/login.php" method="post" role="form" style="display: block;">
                            ...
                            <form id="register-form" action="/godmusic/login.php" method="POST" role="form" style="display: none;">
                                <div class="form-group">
                                    <input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="s-header-v2__navbar-row">
                    ...
                    <div class="s-header-v2__navbar-col s-header-v2__navbar-col-width--180">
                        ...
                        <div class="s-header-v2__logo">
                            <a href="/godmusic/HTML/index_home.php" class="s-header-v2__logo-link">
